...
const clothingItems: ClothingItem[] = [
  {
    ...
    category: 'head',
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" viewBox="0 0 32 32">
  ...
  },
  {
    ...
    category: 'head',
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" viewBox="0 0 512 512">
  ...
  },
  {
    ...
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" viewBox="0 0 15 15">
  ...
  },
  {
    ...
    category: 'clothing',
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" viewBox="0 0 448 512">
...
const ClothingInterface: React.FC = () => {
  ...
  const renderClothingButton = (item: ClothingItem, index: number) => {
    ...
    return (
      <motion.button
        ...
        className="w-20 hidden h-20 rounded-lg border bg-white border-gray-600 text-secondary flex flex-col items-center justify-center gap-1 transition-all duration-200 py-3 cursor-pointer hover:border-gray-800 hover:text-gray-800"
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          >
            {clothingItems.map((item, index) => renderClothingButton(item, index))}
          </motion.div>
        </div>
